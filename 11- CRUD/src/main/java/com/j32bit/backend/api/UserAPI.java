...
public class UserAPI {
    ...
    public ResponseEntity<?> newPage( @RequestBody PageDTO pageDTO, @RequestBody int id) throws SQLException {
        formManagementService.createPage(pageDTO);
        log.info("Application Created");
        return ResponseEntity.ok(new GenericResponse("New Page Created"));
    }
