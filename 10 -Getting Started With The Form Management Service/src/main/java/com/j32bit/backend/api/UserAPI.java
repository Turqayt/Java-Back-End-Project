...
public class UserAPI {
    ...
    @GetMapping("form/applicationlist")
    public ResponseEntity<GenericResponse<ApplicationDTO>> applicationList(){
        ArrayList<ApplicationDTO> applicationDTOS = formManagementService.findAll();
        return ResponseEntity.ok(GenericResponse.createSuccessResponse(applicationDTOS));
    }
